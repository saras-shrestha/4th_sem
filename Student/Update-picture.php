...
<body> 
 ...
 //update process
	if(isset($_POST['submit']))
	{
		...
		/*profile-picture*/
		$sql="UPDATE students SET profile_image='$ulocation' WHERE user_id IN (SELECT uid FROM users WHERE username='".$_SESSION['username']."')" ;
		//$sql="UPDATE students SET profile_image='$ulocation' where stu_id=".$_SESSION['stu_id'];
