		    		...
		    		<form method="post" action="">
		    			<table class='change-pass'>
							...
							if($count==1)
							{
								echo "<tr>
									<th>Old Password</th>
			    					<td><b>:</b> <input type='password' name='old_pass'/> <br/> <span id='oldErr'></span></td>
									</tr>";
								echo "<tr>
									<th>New Password</th>
								...
								echo "<tr>
			    					...
			    					<td><b>:</b> <input type='password' name='con_pass'/> <br/> <span id='conErr'></span></td>
									</tr>";
							}
							?>	
			...
			if($count==1)
			{
				if($old_pass==$row['password'])
				{
					if($new_pass==$confirm_pass)
					{
						...
						if($qry)
						{
							header("Location:Admin_Profile.php?msg=Your password is changed.");
						}
					}
					else
					{
